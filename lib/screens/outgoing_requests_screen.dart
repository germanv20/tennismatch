...
/// Thin Scaffold+AppBar wrapper around [OutgoingRequestsList]. See
/// incoming_requests_screen.dart's IncomingRequestsScreen doc comment for
/// why this stays a separate pushable screen alongside MatchRequestsScreen
/// (which embeds [OutgoingRequestsList] directly as a tab instead).
class OutgoingRequestsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: OutgoingRequestsList(currentUser: currentUser),
    );
  }
}

/// The actual outgoing-requests list — no Scaffold/AppBar of its own, so it
/// can be embedded either inside [OutgoingRequestsScreen] (see above) or
